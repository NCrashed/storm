...
/*****************************************************************************/
module storm.pklib.crc32;

immutable uint[] crc_table =
[
...
uint crc32_pklib(ubyte * buffer, size_t * psize, uint * old_crc)
{
    size_t  size = *psize;
    uint ch;
    uint crc_value = *old_crc;

    while(size-- != 0)
    {
        ch = *buffer++ ^ cast(ubyte)crc_value;
        crc_value >>= 8;
